...
export const PERFIS_QUIZ: Record<string, PerfilQuiz> = {
  ...
  monarca: {
    ...
    playlistNome: 'Hip-Hop / Trap Luxury',
  ...
  chama: {
    ...
    iconeId: 'chama',
    playlistUrl: 'https://open.spotify.com/playlist/37i9dQZF1DXdVbxH4KHjPK',
    playlistNome: 'Funk Ostentação',
  ...
  nomade: {
    ...
    iconeId: 'bussola',
    playlistUrl: 'https://open.spotify.com/playlist/37i9dQZF1DX8tZsk68tuDw',
    playlistNome: 'Hits do Momento',
  ...
  fantasma: {
    ...
    iconeId: 'lua',
    playlistUrl: 'https://open.spotify.com/playlist/37i9dQZF1DX2L0iB23Enbq',
    playlistNome: 'Dark Electronic / Ambient',
  ...
  maestro: {
    ...
    iconeId: 'notas',
    playlistUrl: 'https://open.spotify.com/playlist/37i9dQZF1DXa91D8NplYZa',
    playlistNome: 'Electronic / House Vibes',
  ...
  diplomata: {
    ...
    playlistNome: 'Pop Brasil / Good Vibes',
  ...
  predador: {
    ...
    playlistNome: 'Funk Carioca / Proibidão',
  ...
  curador: {
    ...
    iconeId: 'diamante',
    playlistUrl: 'https://open.spotify.com/playlist/37i9dQZF1DX7K31D69s4M1',
    playlistNome: 'Jazz / Lo-fi Luxury',
  ...
  ativador: {
    ...
    playlistNome: 'Dance / EDM Warm-up',
  ...
  lendario: {
    ...
    playlistNome: 'Party Anthems / Flashback',
  ...
  sedutor: {
    ...
    playlistUrl: 'https://open.spotify.com/playlist/37i9dQZF1DX2TRYkJECvfC',

...
export const PERFIS_QUIZ: Record<string, PerfilQuiz> = {
  ...
  monarca: {
    ...
    iconeId: 'coroa',
    playlistUrl: 'https://open.spotify.com/playlist/30YT4tFyMUTqke4xqdqyuV',
    playlistNome: 'Trap Brasil 2026',
  ...
  chama: {
    ...
    iconeId: 'chama',
    playlistUrl: 'https://open.spotify.com/playlist/0g9DQ9UB0Vr1y3KwgAXr1C',
    playlistNome: 'Funk 2026 As Melhores',
  ...
  arquiteto: {
    ...
    iconeId: 'compasso',
    playlistUrl: 'https://open.spotify.com/playlist/7nppx7uLgcmkZHg70HNfOk',
    playlistNome: 'Tech House 2026',
  ...
  nomade: {
    ...
    iconeId: 'bussola',
    playlistUrl: 'https://open.spotify.com/playlist/6IKQrtMc4c00YzONcUt7QH',
    playlistNome: 'Chill Vibes 2026',
  ...
  fantasma: {
    ...
    iconeId: 'lua',
    playlistUrl: 'https://open.spotify.com/playlist/6JqrgEHEMAzgfyuQTXYReT',
    playlistNome: 'Dark Techno 2026',
  ...
  maestro: {
    ...
    iconeId: 'notas',
    playlistUrl: 'https://open.spotify.com/playlist/5n1zRXFeRONJoMdVw18M34',
    playlistNome: 'Melodic House & Progressive 2026',
  ...
  diplomata: {
    ...
    iconeId: 'estrelas',
    playlistUrl: 'https://open.spotify.com/playlist/71xG6fIgIX0TeqO9Dat7YJ',
    playlistNome: 'As Mais Tocadas 2026 Top Brasil',
  ...
  predador: {
    ...
    iconeId: 'raio',
    playlistUrl: 'https://open.spotify.com/playlist/0FVLZjAPhLB7oVt61MgQWj',
    playlistNome: 'Funk 2026 Mais Tocados',
  ...
  curador: {
    ...
    iconeId: 'diamante',
    playlistUrl: 'https://open.spotify.com/playlist/6vDGVr652ztNWKZuHvsFvx',
    playlistNome: 'Deep House 2026',
  ...
  ativador: {
    ...
    iconeId: 'flash',
    playlistUrl: 'https://open.spotify.com/playlist/0uxHEGXSlleLGA0NUvzMhe',
    playlistNome: 'Club Party 2026 EDM',
  ...
  lendario: {
    ...
    iconeId: 'trofeu',
    playlistUrl: 'https://open.spotify.com/playlist/6g40a9GjWBkX8ewR0vF9C2',
    playlistNome: 'Dance Music 2026',
  ...
  sedutor: {
    ...
    playlistUrl: 'https://open.spotify.com/playlist/1DpzmhqivDeSF5QBuzpvER',
    playlistNome: 'RNB 2026 Best R&B Songs',
